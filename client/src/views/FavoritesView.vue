	...
	<div class="favorites-view">
		<div class="container">
			...
			<div v-else-if="isEmpty" class="empty">
				...
				<p class="empty-hint">
					Browse the categories and tap the heart
					icon to save places and routes for your
					race weekend.
				</p>
				<RouterLink to="/" class="browse-btn"
					>Browse Categories</RouterLink
				>
			</div>

			<template v-else>
				<section
					v-if="favPlaces.length > 0"
					class="favorites-section"
				>
					<h2 class="section-title">Places</h2>
					<div class="results-grid">
						<PlaceCard
							v-for="place in favPlaces"
							:key="place.id"
							:place="place"
						/>
					</div>
